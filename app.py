...
img_tree_2 = Image.open(urlopen('https://github.com/wallik2/heart-failure-detector/blob/static/static/graph_tree/dtree_render%201.png?raw=true'))
img_tree_51 = Image.open(urlopen('https://github.com/wallik2/heart-failure-detector/blob/static/static/graph_tree/dtree_render%2050.png?raw=true'))
img_tree_89 = Image.open(urlopen('https://github.com/wallik2/heart-failure-detector/blob/static/static/graph_tree/dtree_render%2088.png?raw=true'))
img = [img_tree_2,img_tree_51,img_tree_89]
img_cfm = Image.open(urlopen('https://github.com/wallik2/heart-failure-detector/blob/static/static/confusion_matrix.png?raw=true'))
